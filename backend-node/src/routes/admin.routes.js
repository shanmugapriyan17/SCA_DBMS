...
const SKILLS_DATA = [
  ...
  { skill_name:'React',            category:'Framework',        description:'JavaScript library for building user interfaces and SPAs.' },
  ...
  { skill_name:'Node.js',          category:'Framework',        description:'JavaScript runtime for building fast, scalable server-side applications.' },
